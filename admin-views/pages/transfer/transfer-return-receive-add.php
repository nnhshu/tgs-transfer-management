                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <small class="text-muted d-block">
                                    ...
                                    <span class="text-muted fst-italic">(kế thừa từ phiếu shop trả — tự động copy y hệt sang phiếu nhận trả nội bộ)</span>
                                </small>
...
jQuery(document).ready(function($) {
    ...
    const receiveDoneLabel = 'Nhận hết';
    const syncTargetLabel = 'phiếu nhận trả';
    ...
    function renderTransferInfo() {
        ...
        // Hiển thị nguồn phần mềm kế thừa từ phiếu shop trả
    ...
    function renderProducts() {
        ...
        renderProductRows(mainItems, {
            ...
            countUnit: 'sản phẩm',
            emptyMessage: 'Không có sản phẩm nhận trả'
        });
